...
exports.BagelServerManager = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const fs = __importStar(require("fs"));
const child_process_1 = require("child_process");
class BagelServerManager {
    constructor() {
    ...
    async startServer() {
        ...
        try {
            ...
            this.serverProcess = (0, child_process_1.spawn)('python', [serverScript, '--port', port.toString()], {
    ...
    findBagelServer() {
        ...
        const possiblePaths = [
            ...
            // In workspace
            ...(vscode.workspace.workspaceFolders?.map(folder => path.join(folder.uri.fsPath, 'bagel-server', 'server.py')) || []),
...
exports.BagelServerManager = BagelServerManager;
